...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse p-4 top-0 left-1/2 transform -translate-x-1/2 sm:top-0 sm:left-1/2 sm:transform sm:-translate-x-1/2 md:max-w-[420px]",
      className
    )}
    {...props}
  />
